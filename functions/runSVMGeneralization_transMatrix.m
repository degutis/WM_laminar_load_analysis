function [accuracyAverage] = runSVMGeneralization_transMatrix(dataSet, labels,meanTR,featureSelect,featureZscore,shuffleLabels)
...
accuracyAverage = accuracyAverage_matrix;
